...
class HierarchyDisplay(p.SingletonPlugin):
    ...
    def before_search(self, search_params):
        ...
        check_include_children = dict(c.fields)
        ...
        c.include_children_selected = check_include_children.get("include_children") == "True"
        ...
        if c.include_children_selected:
            ...
            if children_names:
                ...
                query += ' +(organization:{})'.format(c.group_dict.get('name'))
            ...
            search_params['fq'] = 'type:dataset'
            check_include_children = {}
